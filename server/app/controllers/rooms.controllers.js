...
// 				status: false,
// 				message: 'No rooms found with the provided ID.'
// 			});
// 		}
...
// 			status: false,
// 			message: 'An error occurred while trying to delete the room.'
// 		});
// 	}
// };
// SOCKETS
...
// Esta funcion quedo en desuso pero quizas la reutilize mas adelante :º

// roomsCtrl.checkRooms = async (room) => {
// 	// const checkRoom = await Room.findOne({roomName: room})
	
// 	// if (checkRoom !== null) {
// 	// 	const respuesta = await new Respuestas({
// 	// 		status: 'true',
...
// 	// 	const respuesta = await new Respuestas({
// 	// 		status: 'false',
// 	// 		message: 'No existe ninguna sala con ese nombre.'
// 	// 	});
// 	// 	return respuesta
// 	// }
// }
